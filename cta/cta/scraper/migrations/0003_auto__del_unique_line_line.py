...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Line', fields ['line']
        db.delete_unique('scraper_line', ['line'])


    def backwards(self, orm):
        # Adding unique constraint on 'Line', fields ['line']
        db.create_unique('scraper_line', ['line'])
