...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('scraper_line', (
            ...
            ('line', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True, null=True)),
        ))
    ...
    models = {
        ...
        'scraper.line': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'line': ('django.db.models.fields.CharField', [], {'max_length': '20', 'unique': 'True', 'null': 'True'}),
