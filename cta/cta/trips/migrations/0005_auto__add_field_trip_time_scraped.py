...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trip.time_scraped'
        db.add_column('trips_trip', 'time_scraped',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 11, 21, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trip.time_scraped'
        db.delete_column('trips_trip', 'time_scraped')
    ...
    models = {
        ...
        'trips.trip': {
            ...
            'time_scraped': ('django.db.models.fields.DateTimeField', [], {})
        }
    }
